...
public class DeteccaoCarros {
    public static void main(String[] args) {
        ...
        Mat imagemColorida = imread("src\\br\\com\\jc\\outros\\carro3.jpg", CV_LOAD_IMAGE_COLOR);
        ...
        CascadeClassifier classificador = new CascadeClassifier("src\\br\\com\\jc\\cascades\\cars.xml");

        MatOfRect carrosDetectados = new MatOfRect();
        ...
        System.out.println(carrosDetectados.toArray().length);

        for(Rect rect: carrosDetectados.toArray()){
