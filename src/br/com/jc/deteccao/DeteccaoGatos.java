...
public class DeteccaoGatos {
    public static void main(String[] args) {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        Mat imagemColorida = imread("src\\br\\com\\jc\\outros\\gato3.jpg", CV_LOAD_IMAGE_COLOR);
        ...
        CascadeClassifier classificador = new CascadeClassifier("src\\br\\com\\jc\\cascades\\haarcascade_frontalcatface.xml");
